  ...
  return (
    <div>
      <Head>
        ...
        <script src="../lic/realgrid-lic.js" />
      </Head>
      <AppShell
        padding="md"
        ...
        header={
          <Header height={60} p="xs" sx={(theme) => ({ backgroundColor: theme.colors.blue[9], color: "white", })} >
            <div style={{ display: "flex", alignItems: "center", height: "100%" }} >
              <MediaQuery largerThan="sm" styles={{ display: "none" }}>
                <Burger opened={opened} onClick={() => setOpened((o) => !o)} size="sm" color={theme.colors.gray[3]} mr="xl" />
              </MediaQuery>
              <DogBowl />
              <Text ml={10} size="md">Oregon Humane Adoptable Dogs</Text>
            </div>
          </Header>
        }
        styles={(theme) => ({
